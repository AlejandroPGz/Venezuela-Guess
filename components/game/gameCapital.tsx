import { useGameCapital } from '../../hooks/useGameCapital'
...
const GameCapital = memo(({level}) => {
    ...
    const handleTouch = useCallback((option, index) => {
      setGameState((prevState) => {
        const isCorrect = option === gameArray[prevState.indexGame].capital;
        return {
          ...prevState,
          selected: true,
  ...
  useGameCapital(gameArray, states, setGameState, gameState);
...
export default memo(GameCapital);